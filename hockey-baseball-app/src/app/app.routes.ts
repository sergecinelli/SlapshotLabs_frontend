  ...
  // Main application routes with layout
  {
    ...
    children: [
      ...
      { 
        ...
        loadComponent: () => import('./pages/account/profile/profile').then(m => m.ProfileComponent)
      },
      { 
        path: 'account/payment-method', 
        loadComponent: () => import('./pages/account/payment-method/payment-method').then(m => m.PaymentMethodComponent)
      },
      { 
        path: 'account/payment-history', 
        loadComponent: () => import('./pages/account/payment-history/payment-history').then(m => m.PaymentHistoryComponent)
      },
      ...
      { 
        path: 'video-library', 
        loadComponent: () => import('./pages/video-library/video-library').then(m => m.VideoLibraryComponent)
      },
      { 
        path: 'highlights', 
        loadComponent: () => import('./pages/video-highlights/video-highlights').then(m => m.VideoHighlightsComponent)
      },
      { 
        path: 'live-dashboard/:gameId', 
        loadComponent: () => import('./pages/live-dashboard/live-dashboard').then(m => m.LiveDashboardComponent)
      },
    ]
  },
